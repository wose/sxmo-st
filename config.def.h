 ...
 */
static char *font = "Hurmit Nerd Font:pixelsize=15:antialias=true:autohint=true";
...
static unsigned int doubleclicktimeout = 1000;
static unsigned int tripleclicktimeout = 2000;
